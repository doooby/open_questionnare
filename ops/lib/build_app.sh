...
echo "running: assets & frontend build"
docker run --rm -v $lib_path/frontend/build:/app/public -v $lib_path/frontend:/var/frontend -v $lib_path/frontend/node_modules:/app/app/frontend/node_modules app:production bash -c "cp -R public/* /var/www && bash ops/lib/frontend/build.sh && cp -R public/* /var/www"
