...
docker run --rm -v $lib_path/www:/var/www -v $lib_path/assets:/app/public/assets app:production bash -c "rm -rf /var/www/* && bin/rails assets:precompile assets:clean && cp -R public/* /var/www"

echo "running: frontend build"
docker run --rm -v $lib_path/frontend:/var/frontend -v $lib_path/frontend/node_modules:/app/app/frontend/node_modules app:production bash -c "rm -rf /var/frontend/build && bash ops/lib/frontend/build.sh && cp -R app/frontend/build /var/frontend/build"
